...
import { Search, Sun, Moon, Command, Bell, User } from 'lucide-react';
...
export function Topbar() {
  ...
  return (
    <header className="h-14 border-b border-neutral-200/60 dark:border-neutral-800/60 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md sticky top-0 z-40">
      <div className="flex items-center justify-between h-full px-4 md:px-6">
        ...
        >
          ...
          <span className="hidden sm:inline">Search docs, sources, commands...</span>
